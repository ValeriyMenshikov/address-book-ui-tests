...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_new_user(wd, firstname="asdasdasd", middlename="asdasd", lastname="asdfvf", nickname="asdfsdf",
                             title="sadfvsdf", company="asdfsdfsdf", address="bvbbgfbdfgb",
                             home="dcfscfsd", mobile="12312323", work="dsfsdf", fax="123123123", mail="asdasd@mail.ru",
    ...
    def create_new_user(self, wd, firstname, middlename, lastname, title, nickname, company, address, home, mobile,
                        work, fax, mail, email2, email3, homepage, bday, bmonth, byear, aday, amonth, ayear, address2,
                        phone2, notes):
        # init user creation
